...
class ScrapeWebsiteTool(BaseTool):
    name = "scrape_website"
    description = "Scrape data from a website url. Pass URL and objective to the function."
...
def search(query):
    """Send a search request with the given query."""
...
def scrape_website(objective: str, url: str):
    """Scrape the website and summarize the content based on the objective."""
...
def summarize_content(objective, content):
    """Summarize the given content based on the objective."""
